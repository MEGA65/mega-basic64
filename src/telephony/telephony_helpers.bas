...
SWITCH_TO_SCREEN_DEBUG gosub RINGTONE_OFF: gosub SWITCH_SCREEN_INIT:sc=0:gosub SWITCH_SCREEN_CLEANUP:su=1:return

'=== switch to screen DIALLER (1) ===
'set back previously highlighted contact
'Mark entire screen as requiring a re-draw
SWITCH_TO_SCREEN_DIALLER gosub RINGTONE_OFF: gosub SWITCH_SCREEN_INIT:sc=1:gosub SWITCH_SCREEN_CLEANUP:p=cselected%: gosub PHONEBOOK_TO_CONTACT_PANE_INDEX: hl%=k :su=1: up=1: uc=1: ud=1:return

'=== switch to screen CONTACT (2) ===
SWITCH_TO_SCREEN_CONTACT gosub RINGTONE_OFF: gosub SWITCH_SCREEN_INIT:sc=2:gosub SWITCH_SCREEN_CLEANUP:su=1:ul%=0:gosub PREP_CONTACT:return
...
SWITCH_TO_SCREEN_CONTACT_EDIT gosub RINGTONE_OFF: gosub SWITCH_SCREEN_INIT:sc=4:gosub SWITCH_SCREEN_CLEANUP:su=1:hl%=0: ul%=0
...
SWITCH_TO_SCREEN_SMS gosub RINGTONE_OFF: gosub SWITCH_SCREEN_INIT:sc=5:gosub SWITCH_SCREEN_CLEANUP:su=1:gosub SMS_TO_SMS_PANE:return
