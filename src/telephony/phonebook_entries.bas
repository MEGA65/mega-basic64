...
'pnumber$(6)="0123456789123": ptype%(6)=129 : ptxt$(6)="a string longer than 20"
'len(pnumber)<12 and len(ptxt)+len(pnumber)>35
'pnumber$(7)="0123456789": ptype%(7)=161 : ptxt$(7)="a string that is too long"
'len(ptxt)<20 and len(ptxt)+len(pnumber)>35
'pnumber$(8)="1234567890123456789012345": ptype%(8)=161 : ptxt$(8)="short string"
return
